...
## **Pasante de Desarrollo Web**, Decasystems -- Santiago, República Dominicana
...
Proyecto freelance para una empresa de gestión residencial
...
**Bases de Datos y Persistencia:** PostgreSQL, Flyway (Migration), Hibernate ORM, JPA, H2

**Infraestructura y DevOps:** Docker, Docker Compose, AWS, DigitalOcean (Droplets, Spaces), GitHub Actions (CI/CD)

**Movil:** Android Development (Jetpack Compose, Room)
